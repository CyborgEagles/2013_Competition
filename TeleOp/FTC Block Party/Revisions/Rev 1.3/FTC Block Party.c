...
#pragma config(Motor,  mtr_S1_C3_1,     extentionMotor, tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C3_2,     flagSpinner,   tmotorTetrix, openLoop)
